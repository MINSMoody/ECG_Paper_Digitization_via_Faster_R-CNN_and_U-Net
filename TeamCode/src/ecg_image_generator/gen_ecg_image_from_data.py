...
from TeamCode.src.ecg_image_generator.helper_functions import find_files, read_config_file
from TeamCode.src.ecg_image_generator.extract_leads import get_paper_ecg
# from TeamCode.src.ecg_image_generator.HandwrittenText.generate import get_handwritten
from TeamCode.src.ecg_image_generator.CreasesWrinkles.creases import get_creased
from TeamCode.src.ecg_image_generator.ImageAugmentation.augment import get_augment
import warnings
import cv2
...
def run_single_file(args):
        ...
        font = os.path.join('Fonts',random.choice(os.listdir("./TeamCode/src/ecg_image_generator/Fonts")))
        ...
        for out in out_array:
            ...
            # Handwritten text not included in this version!!!!
            # if(hw_text):
